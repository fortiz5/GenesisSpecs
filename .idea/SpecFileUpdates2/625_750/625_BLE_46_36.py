...
#6FREQ_625 45.8_35.5 (46_36)
#BLE120_46_T10

#Start with curor in name field

def BLE120_46_T10():
    BLE120_46_T10_rename()
    heside_625()
    ds_625()
    BLE_pwr()
    BLE_fgain10()
...
def heside_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('13.7')  #HES 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('16.5')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('16.9')  #HES 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('17.7')  # HES 750
#Update DS side 1
def ds_625():
    keyboard.press_and_release('tab')
    time.sleep(.1)
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('36')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('43.3')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('44.4')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('46.2')  #DS 750
