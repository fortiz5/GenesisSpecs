...
#6FREQ_625 45.7_34 (46_34)
#BLE120_46_T12

#Start with curor in name field

def BLE120_46_T12():
    BLE120_46_T12_rename()
    heside_625()
    ds_625()
    BLE_pwr()
    BLE_fgain12()
...
def ds_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('34')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('42.5')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('43.8')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('46')  #DS 750
