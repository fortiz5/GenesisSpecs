...
#6FREQ_625 45_33 (45_33)
#BLE120_45_T12

#Start with curor in name field

def BLE120_45_T12():
    BLE120_45_T12_rename()
    heside_625()
    ds_625()
    BLE_pwr()
    BLE_fgain12()
...
def ds_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('42.0')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('43.3')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('45.6')  #DS 750
