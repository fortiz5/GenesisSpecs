...
#5 FREQ 5,40,54,550,750 convert 48.5_36 to 48_36
#MB120_48_T12
...
def heside_550():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('6.4')  #HES 54
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('8.5')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('8.8')  #HES 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('9.3')  # HES 750
#Update DS side 1
def ds_550():
    keyboard.press_and_release('tab')
    time.sleep(.01)
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('45.0')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('48.3')  #DS 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('48.6')  #DS 750
