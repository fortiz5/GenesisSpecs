...
#5 FREQ 5,40,54,550,750 convert 44_30 to 44_32
#MB120_44_T14
...
def heside_550():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('4.4')  #HES 54
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('7.3')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('8.8')  #HES 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('8.5')  # HES 750
#Update DS side 1
def ds_550():
    keyboard.press_and_release('tab')
    time.sleep(.01)
