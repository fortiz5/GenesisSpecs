...
#5FREQ_550 44_30 (44_30)
#BLE120_44_T14

#Start with curor in name field

def BLE120_44_T14():
    BLE120_44_T14_rename()
    heside_550()
    ds_550()
    BLE_pwr()
    BLE_fgain14()
...
def heside_550():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('7.7')  #HES 54
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('13.1')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('14.9')  #HES 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('15.2')  # HES 750
#Update DS side 1
def ds_550():
    keyboard.press_and_release('tab')
    time.sleep(.01)
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('30')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('39.8')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('43.8')  #DS 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('43.8')  #DS 750
