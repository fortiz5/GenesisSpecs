...
def heside_550():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('9.3')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('10.5')  #HES 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('10.5')  # HES 750
#Update DS side 1
def ds_550():
    keyboard.press_and_release('tab')
    time.sleep(.01)
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('47.8')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('48.3')  #DS 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('51.8')  #DS 750
