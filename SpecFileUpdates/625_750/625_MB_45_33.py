...
def heside_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('7.4')  #HES 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('9.1')   #HES 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('9.3')  #HES 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('9.7')  # HES 750
#Update DS side 1
def ds_625():
    keyboard.press_and_release('tab')
    time.sleep(.1)
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('33')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('41.5')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('42.8')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('45.0')  #DS 750
