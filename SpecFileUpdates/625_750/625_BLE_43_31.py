...
def ds_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('31')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('39.5')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('40.8')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('43')  #DS 750
