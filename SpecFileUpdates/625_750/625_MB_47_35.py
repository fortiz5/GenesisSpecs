...
def ds_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('44.0')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('45.3')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('47.6')  #DS 750
