...
def ds_625():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('44.5')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('45.8')  #DS 625
    keyboard.press_and_release('tab')
    time.sleep(.1)
    keyboard.write('48.0')  #DS 750
