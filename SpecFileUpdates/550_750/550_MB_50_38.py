...
#5 FREQ 5,40,54,550,750 convert 54_40 to 50_38
#MB120_50_T12
...
def ds_550():
    ...
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('38')  #DS 54
    keyboard.press_and_release('tab')
    time.sleep(.01)
    keyboard.write('47.0')  #DS 550
    keyboard.press_and_release('tab')
    time.sleep(.01)
    #keyboard.write('48.3')  #DS 625
    #keyboard.press_and_release('tab')
    #time.sleep(.01)
    keyboard.write('50.6')  #DS 750
